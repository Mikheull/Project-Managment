    ...
    <div class="card-item light-border margin-bot">
        <div class="header relative">
            ...
            <div class="flex justify-content-between">
                <div class="status margin-top margin-left <?= $utils -> getData('pr_team', 'public', 'public_token', $t['public_token']) == true ? 'bg-primary' : 'bg-red' ;?> color-light text-xs">
                    <?= $utils -> getData('pr_team', 'public', 'public_token', $t['public_token']) == true ? 'publique' : 'privée' ;?>
                </div>
            ...
            <div class="heading text-align-center margin-top-lg">
                ...
                <div class="name title-sm bold"> <a class="link light-link"> <?= $utils -> getData('pr_team', 'name', 'public_token', $t['public_token']) ;?> </a> </div>
            </div>
        </div>

        <div class="content margin-bot-lg text-align-center">
            <div class="desc color-red margin-top-lg"> L'équipe est actuellement archivé, désarchivé là pour y avoir accès </div>
        </div>
