    ...
    <div class="card-item light-border margin-bot">
        <div class="header relative">
            ...
            <div class="flex justify-content-between">
                <div class="status margin-top margin-left <?= $utils -> getData('pr_project', 'public', 'public_token', $t['public_token']) == true ? 'bg-primary' : 'bg-red' ;?> color-light text-xs">
        ...
        <div class="content margin-bot-lg text-align-center">
            <div class="desc color-red margin-top-lg"> Le projet est actuellement archivé, désarchivé là pour y avoir accès </div>
        </div>
