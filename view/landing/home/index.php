    ...
    <div class="container home_pre">
        <div class="row">
            <div class="col-md-5 col-12 align-self-center left" data-aos="fade-up" data-aos-duration="600">
                <h2 class="title-lg bold color-dark mr-bot">Gérez vos projets et vos équipes</h2>
                <h3 class="title-xs color-gray">Gagnez du temps en restant organisé</h3>
                <div class="btns mr-top-lg mr-right"> <a href="<?= $config -> rootUrl() ;?>app" title="Débuter un projet" class="btn primary-btn">Lancez votre projet</a> </div>
                <div class="btns mr-top-lg"> <a href="" title="Regarder la vidéo" class="btn light-btn-bordered open_pres-video"><i data-feather="play-circle"></i> Regarder la vidéo</a> </div>
            </div>
    ...
    <div class="container home_presentation">
        <div class="row pres-element" data-aos="fade-right" data-aos-duration="700">
            ...
            <div class="col-md-6 col-10 heading align-self-center order-md-2 order-1">
                <h2 class="title-sm bold color-dark mr-bot mr-left">Gérez votre équipe</h2>
                <p class="color-gray">Nunc vero inanes flatus quorundam vile esse quicquid extra urbis pomerium nascitur aestimant praeter orbos et caelibes, nec credi potest qua obsequiorum diversitate coluntur homines sine liberis Romae.</p>
            </div>
        </div>
        ...
        <div class="row pres-element" data-aos="fade-right" data-aos-duration="700">
            <div class="col-md-6 col-10 heading align-self-center">
                <h2 class="title-sm bold color-dark mr-bot mr-left">Maintenez votre projet</h2>
                <p class="color-gray">Nunc vero inanes flatus quorundam vile esse quicquid extra urbis pomerium nascitur aestimant praeter orbos et caelibes, nec credi potest qua obsequiorum diversitate coluntur homines sine liberis Romae.</p>
            </div>
        ...
        <div class="row pres-element" data-aos="fade-right" data-aos-duration="700">
            ...
            <div class="col-md-6 col-10 heading align-self-center order-md-2 order-1">
                <h2 class="title-sm bold color-dark mr-bot mr-left">Partagez votre expérience</h2>
                <p class="color-gray">Nunc vero inanes flatus quorundam vile esse quicquid extra urbis pomerium nascitur aestimant praeter orbos et caelibes, nec credi potest qua obsequiorum diversitate coluntur homines sine liberis Romae.</p>
            </div>
        </div>
        ...
        <div class="row pres-element" data-aos="fade-right" data-aos-duration="700">
            <div class="col-md-6 col-10 heading align-self-center">
                <h2 class="title-sm bold color-dark mr-bot mr-left">Agrandissez votre réseau</h2>
                <p class="color-gray">Nunc vero inanes flatus quorundam vile esse quicquid extra urbis pomerium nascitur aestimant praeter orbos et caelibes, nec credi potest qua obsequiorum diversitate coluntur homines sine liberis Romae.</p>
            </div>
