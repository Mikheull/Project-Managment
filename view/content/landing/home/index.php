...
<section class="main_container">
    ...
    <div class="container home_pre">
        <div class="row">
            <div class="col-md-5 col-12 align-self-center left">
                ...
                <div class="btns"> <a href="<?= $config -> rootUrl() ;?>app" title="Débuter un projet" class="btn primary-btn">Lancez votre projet</a> </div>
                <div class="btns"> <a href="" title="Regarder la vidéo" class="btn light-btn"><i class="far fa-play-circle"></i> Regarder la vidéo</a> </div>
    ...
    <div class="container home_presentation">
        <div class="row pres-element">
            <div class="col-md-6 col-12 heading align-self-center">
        ...
        <div class="row pres-element">
            <div class="col-md-6 col-10 illustration order-md-1 order-2"> <img src="dist/images/illustrations/team_managment.svg" alt="" width="80%"> </div>
