...
?>
        ...
        <div class="container account floating_container edit">
            <div class="heading">Modifier ses informations</div>
            ...
            <form method="POST">
                ...
                <button class="primary-btn" name="update_user_infos">Sauvegarder</button>
            </form>
            ...
            <form method="POST">
                ...
                <button class="primary-btn" name="update_user_pass">Sauvegarder</button>
            </form>
...
<?php
        ...
        header('location: login?return_url=account%2Fedit');
    }
?>