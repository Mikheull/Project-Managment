                            ...
                            <div class="container light-border margin-bot-lg">
                                <div class="row margin-top margin-bot">
                                    ...
                                    <div class="col-12 margin-top expand_content hidden">
                                        ...
                                        <div class="spacebar spacebar-xl"></div>
                                        <div class="margin-top text-align-right link" style="color: #d9480f" id="move-to-working" data-bug="<?= $bug_item['bug_token'] ?>" data-pro="<?= $project_token ?>">En cours <i class="fas fa-arrow-right"></i></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container light-border margin-bot-lg">
                                <div class="row margin-top margin-bot">
                                    ...
                                    <div class="col-12 margin-top expand_content hidden">
                                        ...
                                        <div class="spacebar spacebar-xl"></div>
                                        <div class="margin-top text-align-right link" style="color: #2b8a3e" id="move-to-end" data-bug="<?= $bug_item['bug_token'] ?>" data-pro="<?= $project_token ?>">Terminé <i class="fas fa-arrow-right"></i></div>
                                    </div>
                                </div>
                            </div>
