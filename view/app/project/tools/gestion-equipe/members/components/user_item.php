<div class="col-md-4 col-12 margin-bot flex">
    <div class="flex">
        ...
        <div class="name margin-left margin-top"> <?= $utils -> getData('imp_user', 'username', 'public_token', $u['user_public_token']) ?>  </div>
    </div>
    <div class="margin-top margin-left <?= $utils -> getData('pr_project', 'founder_token', 'public_token', $router -> getRouteParam('2')) !== $auth -> getToken() ? 'hidden' : '' ;?>">
