...
<div class="details_container container light-border">
    ...
    <div class="row">
        <div class="col-12 mr-bot-lg">
            ...
            <ul>
                <li class="mr-left mr-top">Nom : <span class="color-lg-dark"><?= $utils -> getData('pr_event', 'name', 'event_token', $exp[1] ) ;?></span> </li>
                <li class="mr-left">Description : <span class="color-lg-dark"><?= $utils -> getData('pr_event', 'description', 'event_token', $exp[1] ) ;?></span> </li>
                <li class="mr-left">Date : <span class="color-lg-dark"><?= $utils -> getData('pr_event', 'date_begin', 'event_token', $exp[1] ) ;?></span> </li>
            </ul>
        </div>
        ...
        <div class="col-12 mr-bot-lg">
            ...
            <ul>
                <li class="mr-left mr-top">Date de création : <span class="color-lg-dark">undefined</span> </li>
    ...
    <div class="row">
        <div class="col-12 flex mr-bot">
            <div class="btn btn-sm dark-btn mr-right" data-action="edit_event" data-ref="<?= $exp[1] ?>"><i class="fas fa-edit"></i></div>
            <div class="btn btn-sm mr-right dark-btn" id="sharing"><i class="far fa-share-square"></i></div>
            <div class="btn btn-sm mr-right dark-btn" data-action="delete_event" data-ref="<?= $exp[1] ?>"><i class="far fa-trash-alt"></i></div>
            <?php
