                ...
                <li class="col-md-5 col-12 pl-0">
                    <div class="pt-3 pb-3 container light-border mr-bot">
                        <div class="row">
                            ...
                            <div class="col-2 text-align-right"> <a href="<?= $config -> rootUrl() ;?>app/project/<?= $router -> getRouteParam('2') ?>/t/recherche-utilisateur/<?= $research['research_token']?>"> <i class="fas fa-ellipsis-h"> </i> </a> </div>
                        </div>
                    </div>
                </li> 
            <?php
