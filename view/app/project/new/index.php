...
<div class="container-fluid main_wrapper new_team">
    <div class="creator_head container">
        <div class="row text-align-center">
            <div class="col-12"><h3 class="title-sm color-dark margin-bot-lg margin-top">Créer un projet</h3></div>
        ...
        <div class="row">
            ...
            <form action="" method="post">
                ...
                <div class="step-content text-align-left margin-top margin-left margin-right" id="second-step">
                    <div class="head">
                        <h3 class="title-xs color-dark margin-bot margin-top">Accès au projet</h3>
