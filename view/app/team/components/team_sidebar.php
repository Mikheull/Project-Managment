        ...
        <div class="row navbar-nav">
            <div class="col-8 nav-left">
                ...
                <ul>
                    ...
                    <li class="nav-item"> <a href="<?= $config -> rootUrl() ;?>app/team/<?= $router -> getRouteParam("2") ?>/roles"> Rôles </a> </li>
            ...
            <div class="col-4 nav-right">
                <ul class="text-align-right">
                    <li class="nav-item"> <a href="<?= $config -> rootUrl() ;?>notifications" title="notifications"><i class="fas fa-bell"></i></a> </li>
                    <li class="nav-item"> <a href="<?= $config -> rootUrl() ;?>notifications" title="notifications"><i class="fas fa-bell"></i></a> </li>
